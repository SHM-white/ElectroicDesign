"""Legacy code rollback — simplified bringup without strict lifecycle enforcement."""
...
PROFILE = "offline"
LIFECYCLE_ORDER = ("calibration_gate", "robot_state_publisher")
...
def generate_launch_description() -> LaunchDescription:
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                "authority_token",
                default_value="ed-uav-legacy-rollback",
