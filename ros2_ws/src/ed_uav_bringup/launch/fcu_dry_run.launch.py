"""FCU dry-run with fake PTY — no physical flight controller required."""
...
PROFILE = "offline"
LIFECYCLE_ORDER = ("calibration_gate", "robot_state_publisher", "fcu_dry")
    ...
    return LaunchDescription(
        [
            DeclareLaunchArgument(
                ...
                description="Path to the fake PTY device for FCU dry-run communication.",
            ),
            DeclareLaunchArgument(
                "calibration_file",
